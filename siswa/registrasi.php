...
<html lang="en">
<head>
<title>Administrator SMP MTSS PUI Maja</title>
<meta charset="utf-8">
...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_12">
			...
			<a id="site-title">E-Learning <span>SMP MTSS PUI Maja - Jawa Barat</span></a>			
		</div>
	</div>
</header>
...
<div id="login2" class="box">
	<h2>Registrasi Siswa</h2>
		<form class="form-2" method="POST" action="input_registrasi.php" onSubmit="return validasi(this)">
			<dl>
