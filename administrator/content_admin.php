...
if ($_GET['module']=='home'){
  ...
  echo "<p>Hai <b>$_SESSION[namalengkap]</b>, Selamat datang di halaman Administrator E-learning SMP MTSS PUI MAJA Jawa Barat.<br>
  ...
  echo "<p>Hai <b>$_SESSION[namalengkap]</b>, selamat datang di halaman Administrator.<br>
         ...
         //kelas yang diajar
         echo"<form><fieldset>
              <legend>Kelas Yang Anda Ajar</legend>
              <dl class='inline'>
         ...
         if (!empty($ketemu)){
                ...
                echo "</table></dl></fieldset></form>";
                    ...
                    echo"<br><br>Tidak ada kelas yang anda ajar";
                }

   //mata pelajaran
   echo"<form><fieldset>
              <legend>mata pelajaran yang anda ajar</legend>
              <dl class='inline'>
  ...
  if (!empty($cek_mapel)){
    ...
    echo "</table></dl></fieldset></form>";
      ...
      echo"<br><br>Tidak Ada Mata Pelajaran Yang Di Ajar";
  }
...
elseif ($_GET['module']=='laporanabsensi'){
  if ($_SESSION['leveluser']=='admin'){
    include "modul/mod_laporanabsensi/laporanabsensi.php";
  }else{
    include "modul/mod_laporanabsensi/laporanabsensi.php";
  }  
}
// Bagian Laporan Nilai
elseif ($_GET['module']=='laporannilai'){
  if ($_SESSION['leveluser']=='admin'){
    include "modul/mod_laporannilai/laporannilai.php";
  }else{
    include "modul/mod_laporannilai/laporannilai.php";
  }  
}
