...
$module=$_GET['module'];
$act=$_GET['act'];
$tgl_batas_upload=$_POST[thn].'-'.$_POST[bln].'-'.$_POST[tgl];
            ...
            window.location=(href='../../media_admin.php?module=materi')</script>";}
                ...
                if(!in_array($ekstensi, $extensionList)){
                    ...
                    mysql_query("UPDATE file_materi SET judul = '$_POST[judul]',
                                    ...
                                    nama_file = '$nama_file',
                                    tgl_batas_upload = '$tgl_batas_upload',
...
elseif($module=='materi' AND $act=='hapussiswayangtelahupload'){
  $cek = mysql_query("SELECT * FROM siswa_sudah_upload WHERE id = '$_GET[id]'");
                    $r = mysql_fetch_array($cek);
                    if(!empty($r[nama_file])){
                        $file = "../../../files_upload_materi/$r[nama_file]";
                        unlink($file);
                    }                    
                    mysql_query("DELETE FROM siswa_sudah_upload WHERE id = '$_GET[id]'");
  header('location:../../media_admin.php?module='.$module);
