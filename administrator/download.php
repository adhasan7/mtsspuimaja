...
$direktori = "../files_upload_materi/"; // folder tempat penyimpanan file yang boleh didownload
$filename = $_GET['file'];
...
if ($file_extension=='php'){
  ...
  mysql_query("update siswa_sudah_upload set downloads=downloads+1 where nama_file='$filename'");
